			...
			<div className="">
				...
				<div id="codingContent" className="flex flex-col md:flex-row w-full">
					...
					<div className="flex flex-row-reverse md:flex-col w-full justify-center text-center align-center md:items-center">
						<Button size={"sm"} className="flex md:justify-center md:items-center md:content-center md:align-middle mt-4 mb-4 w-20 ml-2 md:mr-0">
							Exécuter
						</Button>
						<p className="flex items-center">0/50</p>
						<p className="flex items-center">Pour ne plus avoir de limites, passer premium!</p>
					</div>
					<Textarea
						className="md:mr-4"
					/>
