		...
		<main className="min-h-[100vh]">
			...
			<div className="">
				...
				<div id="codingContent" className="flex flex-col md:flex-row w-full">
					<div id="codingArea" className="relative min-h-80 md:min-h-[50vh] md:min-w-[45%]">
						<Textarea
						...
						<pre
							className="left-0 z-0 md:ml-4 text-[15pt] resize-none w-[calc(100%-32px)] h-[500px] font-mono border-none m-2.5 p-2 absolute top-0 bg-lightterminalbackground dark:bg-darkterminalbackground rounded-md md:mt-4 leading-[20pt]"
							 id="highlightedCodingContent" aria-hidden="true"
						>
							<code className="language-js text-[15pt] leading-[20pt] font-mono" id="highlighting-content"></code>
						</pre>
						<PrismLoader />
					</div>
					<div
						className="flex flex-row-reverse md:flex-col w-full justify-center text-center align-center md:items-center">
						<Button
							size={"sm"}
					...
					<div id="resultArea" className="relative min-h-80 md:min-h-[50vh] md:min-w-[45%]">
						<Textarea readOnly={true}
							className="left-0 md:mr-4"/>
					</div>
				</div>
			</div>
			{/*<div>*/}
