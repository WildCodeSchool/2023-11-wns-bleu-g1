...
export default function Profile() {
	return (
		<main
			...
			>
				<header
					className={`flex gap-5 w-full max-w-3xl items-center`}>
						<div
							...
							className={`max-w-[60%] text-ellipsis overflow-hidden flex flex-col gap-2`}>
								<h3
									className={`text-4xl text-center`}>
										{"user exists" == true ? "nom de l'utilisateur" : "Utilisateur introuvable"}
								</h3>
				...
				<section 
					className={`flex flex-col gap-5 w-full max-w-3xl text-xl`}
					>
					...
					<div
						className={`flex flex-col gap-4 min-h-[150px]`}
						>
