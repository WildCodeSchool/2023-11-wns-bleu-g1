...
export type GetUserCommentsCountQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserCommentsCountQuery = { __typename?: 'Query', getUserCommentsCount: number };
...
export type GetLanguagesQuery = { __typename?: 'Query', getLanguages: Array<{ __typename?: 'Language', id: string, name: string, version: string, codes: Array<{ __typename?: 'Code', id: string }> }> };
...
export type GetUserLikesCountQuery = { __typename?: 'Query', getUserLikesCount: number };
 ...
 * });
 */
export function useGetUserCommentsCountQuery(baseOptions?: Apollo.QueryHookOptions<GetUserCommentsCountQuery, GetUserCommentsCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserCommentsCountQuery, GetUserCommentsCountQueryVariables>(GetUserCommentsCountDocument, options);
      }
export function useGetUserCommentsCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserCommentsCountQuery, GetUserCommentsCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserCommentsCountQuery, GetUserCommentsCountQueryVariables>(GetUserCommentsCountDocument, options);
        }
export type GetUserCommentsCountQueryHookResult = ReturnType<typeof useGetUserCommentsCountQuery>;
export type GetUserCommentsCountLazyQueryHookResult = ReturnType<typeof useGetUserCommentsCountLazyQuery>;
export type GetUserCommentsCountQueryResult = Apollo.QueryResult<GetUserCommentsCountQuery, GetUserCommentsCountQueryVariables>;
 ...
 * });
 */
export function useGetUserLikesCountQuery(baseOptions?: Apollo.QueryHookOptions<GetUserLikesCountQuery, GetUserLikesCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserLikesCountQuery, GetUserLikesCountQueryVariables>(GetUserLikesCountDocument, options);
      }
export function useGetUserLikesCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserLikesCountQuery, GetUserLikesCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserLikesCountQuery, GetUserLikesCountQueryVariables>(GetUserLikesCountDocument, options);
        }
export type GetUserLikesCountQueryHookResult = ReturnType<typeof useGetUserLikesCountQuery>;
export type GetUserLikesCountLazyQueryHookResult = ReturnType<typeof useGetUserLikesCountLazyQuery>;
export type GetUserLikesCountQueryResult = Apollo.QueryResult<GetUserLikesCountQuery, GetUserLikesCountQueryVariables>;
